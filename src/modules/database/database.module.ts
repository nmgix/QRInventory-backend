  ...
  imports: [
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService) => ({
        type: "postgres",
        host: configService.get("NODE_ENV") === "development" ? "localhost" : configService.get("POSTGRES_HOST"),
...
export const TypeOrmTestingModule = () => [
  ...
  TypeOrmModule.forRootAsync({
    ...
    useFactory: (configService: ConfigService) => ({
      type: "postgres",
      host: configService.get("NODE_ENV") === "development" ? "localhost" : configService.get("POSTGRES_TEST_HOST"),
