...
export class Init1685609109526 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a1182c83652c82053314fb6208" ON "cabinet_teachers_user" ("cabinetId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_df382d4bb9b3282238e1533584" ON "cabinet_teachers_user" ("userId") `
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d30c846fbcf96e26a01d618d61" ON "cabinet_items_item" ("cabinetId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_fe415677d3fea0256adcb178e8" ON "cabinet_items_item" ("itemId") `
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "cabinet_items_item" DROP CONSTRAINT "FK_fe415677d3fea0256adcb178e83"`
    );
    await queryRunner.query(
      `ALTER TABLE "cabinet_items_item" DROP CONSTRAINT "FK_d30c846fbcf96e26a01d618d618"`
    );
    await queryRunner.query(
      `ALTER TABLE "cabinet_teachers_user" DROP CONSTRAINT "FK_df382d4bb9b3282238e15335849"`
    );
    await queryRunner.query(
      `ALTER TABLE "cabinet_teachers_user" DROP CONSTRAINT "FK_a1182c83652c82053314fb62089"`
    );
    await queryRunner.query(
      `ALTER TABLE "institution" DROP CONSTRAINT "FK_c818a4fb122f2e1cfe887bcada1"`
    );
    await queryRunner.query(
      `ALTER TABLE "cabinet" DROP CONSTRAINT "FK_af6fd1a721927f02acce878b5f6"`
    );
